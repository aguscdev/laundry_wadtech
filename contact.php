...
<body >
    <div class="main-wrapper">
        ...
        <div class="section grey text-center m-t-60 p-t-40 p-b-40" id="banner-footer">
            <h2 class="normal m-b-10">
                Hubungi Kami Custemer Service 24 jam</h2>
            <p>
                Kamin menerima keluhan dan masukkan dari pelanggan-pelanggan setia kami 24 jam, karna kami ingin berada di hati pelanggan.</p>
        </div>
                        ...
                        <div class="col-md-6 feature-list">
                            ...
                            <section class="p-t-20 p-b-20">
                                ...
                                <ul class="address-list">
                                    <li><i class="fa fa-map-marker"></i><strong>Address:</strong> Tangerang, kab.Tangerang, Prop,Banten</li>
                                    <li><i class="fa fa-phone"></i><strong>Phone:</strong> 085778783602</li>
                                    <li><i class="fa fa-envelope"></i><strong>Email:</strong> <a href="mailto:mail@example.com">
                                        wadtech@gmail.com</a></li>
                                </ul>
                            </section>
                        </div>
                    </div>
    ...
    <script src="laundry/assets/plugins/jquery-gmap/gmaps.js" type="text/javascript"></script>
    <!-- END JS PLUGIN -->
    <script src="laundry/assets/js/google_maps.js" type="text/javascript"></script>
